...
const { GET_GERMANY_DATA, GET_FRANCE_DATA, GET_ITALY_DATA, GET_AUSTRIA_DATA } = require('../constants/routes');
const { getGermanyData, getFranceData, getItalyData, getAustriaData } = require('../repositories/data.repository');
